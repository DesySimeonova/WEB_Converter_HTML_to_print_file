document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('fileForm').addEventListener('submit', function(event) {
        ...
        if (file && file.type === 'text/html') {
            ...
            reader.onload = function(e) {
                ...
                updatePageSize('A4', 'content');
                updatePageOrientation('Portrait', 'content');
    ...
    function applySettings() {
        ...
        const currentSettings = {
            maxWords, showPageNumbers, removePageNumbers, showLineNumbers, removeLineNumbers, pageSize, pageOrientation
        };
        ...
        let paginatedContent = paginateContent(modifiedContent, maxWords, showPageNumbers, removePageNumbers, showLineNumbers, removeLineNumbers);
        console.log(paginatedContent);
        //const newContentDiv = document.createElement('div');
        //newContentDiv.classList.add('box');
        //newContentDiv.innerHTML = paginatedContent;
        contentDiv.innerHTML=paginatedContent;

        //contentDiv.parentNode.replaceChild(newContentDiv, contentDiv);
        contentDiv.innerHTML=paginatedContent;
        updatePageSize(pageSize, 'content');
        updatePageOrientation(pageOrientation, 'content');
        //newContentDiv.id = 'newContent';
        console.log(document.getElementById('content'));
        //lastContent = newContentDiv.innerHTML;
    }

    function updatePageSize(pageSize, id) { //maybe add for which id???
    ...
    function updatePageOrientation(pageOrientation, id) {
        const contentDiv = document.getElementById(id);
    ...
    function paginateContent(text, maxWords, showPageNumbers, removePageNumbers, showLineNumbers, removeLineNumbers) {
        console.log("In paginate func");
        console.log(text);
        console.log(words);
        let currentPage = '';
        ...
        words.forEach((word) => {
            ...
            if (showLineNumbers && !removeLineNumbers) { //this is not working!
